...
const xmldom_1 = __webpack_require__(7286);
const semver_1 = __webpack_require__(1383);
const pomHandling_1 = __webpack_require__(75);
const queryArtifactVersion_1 = __webpack_require__(5846);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const pomName = core.getInput('root_pom_filename');
            const pomFile = fs_1.default.readFileSync(pomName !== null || pomName !== undefined ? pomName : 'pom.xml');
            const pomDocument = new xmldom_1.DOMParser().parseFromString(pomFile.toString('utf8'), 'test/xml');
            const artifact = yield pomHandling_1.readArtifact(pomDocument);
            const mavenRepo = core.getInput('maven_repository');
            const mostRecent = yield queryArtifactVersion_1.queryArtifactVersion(artifact, mavenRepo !== null || mavenRepo !== undefined
                ? mavenRepo
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updateParentVersion = exports.readArtifact = void 0;
const core_1 = __webpack_require__(2186);
function readArtifact(pomFile) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            const parent = yield getParentElement(pomFile);
            resolve({
...
function updateParentVersion(pomFile, newParent) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            const parent = yield getParentElement(pomFile);
...
exports.updateParentVersion = updateParentVersion;
function getParentElement(pomFile) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            if (parentNodes.length > 0) {
                ...
                if (groupIds.length > 0 &&
                    ...
                    reject(new Error('Incomplete parent pom reference'));
            }
            else
                reject(new Error('No parent pom reference'));
        });
    });
}
function getStringValueFromElements(element) {
    if (element.textContent != null)
        return element.textContent;
    core_1.error(`Element not contained as expected: ${element}`);
    return '';
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.queryArtifactVersion = void 0;
const xmldom_1 = __webpack_require__(7286);
const core_1 = __webpack_require__(2186);
const node_fetch_1 = __importDefault(__webpack_require__(467));
function queryArtifactVersion(artifact, mvnRepoBaseUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            const url = `${mvnRepoBaseUrl}${artifact.groupId.replace('.', '/')}/${artifact.artifactId}/maven-metadata.xml`;
            core_1.debug(`Query: ${url}`);
            const resp = yield node_fetch_1.default(url);
            if (resp.ok) {
                const text = yield resp.text();
                const res = new xmldom_1.DOMParser().parseFromString(text, 'text/xml');
                try {
                    const lu = res.getElementsByTagName('lastUpdated')[0].textContent;
                    const rel = res.getElementsByTagName('release')[0].textContent;
                    if (lu === null || rel === null) {
                        reject(new Error(`Unsupported XML structure in maven metadata artifact: ${text}`));
                    }
                    resolve({
...
exports.queryArtifactVersion = queryArtifactVersion;
...
var XMLReader = __webpack_require__(2124)/* .XMLReader */ .G;
var DOMImplementation = exports.DOMImplementation = __webpack_require__(4555).DOMImplementation;
exports.XMLSerializer = __webpack_require__(4555).XMLSerializer ;
